const faqData = {
  "before-party": [
    ...
    {
      question:
        "Can I take Blendy Before Party if I am pregnant or breastfeeding?",
      answer:
  ...
  "after-party": [
    ...
    {
      question:
        "Can I take Blendy After Party if I am pregnant or breastfeeding?",
      answer:
  ...
  power: [
    {
      ...
      answer:
        "Blendy Power is a liquid shot supplement designed to boost energy levels and physical performance, thanks to a combination of ingredients like L-tyrosine, L-carnitine, and guarana extract.",
    },
    {
      question: "When should I take Blendy Power?",
      answer:
        "Take Blendy Power before physical activities, workouts, or whenever you need an extra energy boost.",
    },
    {
      question: "What are the main ingredients in Blendy Power?",
      answer:
        "The main ingredients include L-tyrosine, L-carnitine, guarana extract (containing caffeine), green coffee caffeine, ginseng, and natural juices from apple, orange, and passion fruit.",
    },
    {
      question: "Is Blendy Power suitable for athletes?",
      answer:
        "Yes, Blendy Power is an excellent option for athletes and active individuals who need an energy boost before training or competitions.",
    },
    {
      question: "Can I combine Blendy Power with other Blendy products?",
      answer:
        "Yes, you can combine Blendy Power with other Blendy products, but it's important to respect the recommended daily doses and consult a doctor if needed.",
    },
    {
      question: "Can I take Blendy Power if I am pregnant or breastfeeding?",
      answer:
        "Blendy Power contains caffeine and other stimulating ingredients that may not be suitable during pregnancy or breastfeeding. Please consult your healthcare provider before taking this product.",
    },
  ],
};
